...
const ArabicDubbed = (props) => {
  const dispatch = useDispatch();
  const trendingMovies = useSelector(selectArabicContent);
  const [currentIndex, setCurrentIndex] = useState(0);

  useEffect(() => {
    dispatch(fetchArabicContent());
  }, [dispatch]);
const categoryConfig = {
  id: 'arabic-content',
  title: 'Arabic Movies',
  route: '/more/arabic-content'
};
  ...
  return (
    <Container>
      <Header>
        <Title>
          <h3 className="TITLE">✨ Arabic Dubbed ✨</h3>
        </Title>
