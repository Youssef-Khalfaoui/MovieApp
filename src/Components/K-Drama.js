...
import { selectKDrama, fetchKDrama } from "../features/movies/moviesSlice";

const KDrama = (props) => {
  const dispatch = useDispatch();
  const trendingMovies = useSelector(selectKDrama);
