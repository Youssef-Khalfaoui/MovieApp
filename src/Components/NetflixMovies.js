...
const NetflixMovies = (props) => {
  const dispatch = useDispatch();
  const trendingMovies = useSelector(selectNetflixTrending);
  const [currentIndex, setCurrentIndex] = useState(0);

  useEffect(() => {
    dispatch(fetchNetflixTrending());
  }, [dispatch]);
const categoryConfig = {
  id: 'netflix-trending',
  title: 'Netflix Trending',
  route: '/more/netflix-trending'
};
  ...
  return (
    <Container>
      <Header>
        <Title>
          <h3 className="TITLE">Netflix Movies</h3>
